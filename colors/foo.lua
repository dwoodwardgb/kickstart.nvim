...
if vim.o.background == 'light' then
  ...
  hi('Constant',         { fg = 'Blue',                                 ctermfg = 'DarkBlue' })
  hi('Special',          { fg = '#6a5acd',                              ctermfg = 'DarkMagenta' })
  hi('Identifier',       { fg = 'Black',                                ctermfg = 'Black' })
  hi('Statement',        { fg = 'Black', bold = true,                   ctermfg = 'Black' })
  hi('PreProc',          { fg = '#6a0dad',                              ctermfg = 'DarkMagenta' })
  hi('Type',             { fg = 'Black', bold = true,                   ctermfg = 'Black' })
